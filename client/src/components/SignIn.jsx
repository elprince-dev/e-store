      ...
      <section className="justify-center w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-center">
            <button className="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-8 rounded focus:outline text-white">Sign in</button>
          </div>
        </form>
        <p className="align-baseline font-medium mt-4 text-sm text-center">Don't have an account?{" "}
